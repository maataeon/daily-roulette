define("components/starrySky", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("index", ["require", "exports", "components/starrySky"], function (require, exports, starrySky_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const querySelector = (selector) => document.querySelector(selector);
    const inputPalabras = querySelector('#inputPalabras');
    const botonAgregarPalabras = querySelector('#botonAgregarPalabras');
    const listaPalabras = querySelector('#lista-palabras');
    const nombreSeleccionado = querySelector('#nombre-seleccionado');
    const wink = querySelector('#wink');
    const spinSound = querySelector('#spin-sound');
    const whoosh = querySelector('#whoosh');
    const lastName = querySelector('#last-name');
    const tic = querySelector('#tic');
    const time = querySelector('#time');
    const log = querySelector('#log');
    const cronometer = querySelector('#cronometer');
    const botonLimpiarOpciones = querySelector('#limpiar-opciones');
    const alerta = querySelector('#alerta');
